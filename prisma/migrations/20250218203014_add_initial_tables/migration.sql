-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'CONFIRMED', 'IN_PREPARATION', 'FINISHED', 'ON_ITS_WAY', 'DELIVERED', 'CANCELED');

-- CreateEnum
CREATE TYPE "ConsumptionMethod" AS ENUM ('DELIVERY', 'IN_LOCAL', 'TAKEAWAY');
